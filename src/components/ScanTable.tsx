                        ...
                        <Tooltip>
                          <TooltipTrigger>
                            {host.os.toLowerCase().includes("windows") ? (
                              ...
                              <svg className="inline-block h-7 w-7 text-amber-500" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C9.8 2 8 3.8 8 6c0 .7.2 1.4.5 2C7 9 6 10.5 6 12.5c0 1.5.5 2.8 1.2 3.8C6.5 17 6 18 6 19c0 1.7 1.3 3 3 3 .8 0 1.6-.3 2.1-.9.3.1.6.1.9.1s.6 0 .9-.1c.5.6 1.3.9 2.1.9 1.7 0 3-1.3 3-3 0-1-.4-2-1.2-2.7.8-1 1.2-2.3 1.2-3.8 0-2-1-3.5-2.5-4.5.3-.6.5-1.3.5-2 0-2.2-1.8-4-4-4zm-1.5 5c.4 0 .8.1 1.1.3.2-.1.5-.2.8-.3.3.1.6.2.8.3.3-.2.7-.3 1.1-.3.8 0 1.5.5 1.8 1.2-.5.3-1.2.5-1.8.6-.3-.2-.7-.3-1.1-.3-.4 0-.8.1-1.1.3-.6-.1-1.3-.3-1.8-.6.2-.7.8-1.2 1.7-1.2h.5zm-.2 3.5c.5.3 1.1.5 1.7.5s1.2-.2 1.7-.5c1 .6 1.8 1.6 1.8 2.5 0 1-.3 2-.9 2.7-.5-.3-1-.4-1.6-.5V13h-2v1.7c-.6.1-1.1.2-1.6.5-.6-.7-.9-1.7-.9-2.7 0-.9.7-1.9 1.8-2.5zM9 19.5c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5c.5 0 .9.2 1.2.6-.5.5-.7 1.2-.7 1.9 0 .2 0 .3.1.5H9zm6 0c-.2 0-.4 0-.6-.1 0-.2.1-.3.1-.5 0-.7-.3-1.4-.7-1.9.3-.4.7-.6 1.2-.6.8 0 1.5.7 1.5 1.5s-.7 1.6-1.5 1.6z"/></svg>
                            ) : (
